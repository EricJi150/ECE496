...
def test_path(model, test_dataloader, save_path):
    ...
    with open('shadows/pickle/misclassified_shadow_deepfloyd_indoor.pkl', 'wb') as f:
    ...
    roc_curve.full_test(model, misclassified_test_loader, mode="misclassified", save_to_file="shadows/roc/misclassified_deepfloyd_indoor")
    roc_curve.full_test(model, unconfident_misclassified_test_loader, mode="unconfident", save_to_file="shadows/roc/unconfident_deepfloyd_indoor")
...
def main():
    ...
    test_path(model, test_loader, 'deepfloyd_indoor')
