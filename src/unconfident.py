...
def test_path(model, test_dataloader, save_path):
    ...
    with open('shadows/pickle/misclassified_shadow_kadinsky.pkl', 'wb') as f:
        pickle.dump(misclassified_paths, f)
    with open('shadows/pickle/unconfident_shadow_kadinsky.pkl', 'wb') as f:
    ...
    roc_curve.full_test(model, misclassified_test_loader, mode="misclassified", save_to_file="shadows/roc/misclassified_kadinsky", title='ROC for Misclassified Kadinsky(Outdoor) Set')
    roc_curve.full_test(model, unconfident_misclassified_test_loader, mode="unconfident", save_to_file="shadows/roc/unconfident_kadinsky", title='ROC for Unconfident/Misclassified Kadinsky(Outdoor) Set')
