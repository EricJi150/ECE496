...
def test_path(model, test_dataloader, save_path):
    ...
    with open('shadows/pickle/misclassified_shadow_firefly_indoor', 'wb') as f:
    ...
    roc_curve.full_test(model, misclassified_test_loader, mode="misclassified", save_to_file="shadows/roc/misclassified_firefly_indoor", title='ROC for Misclassified Firefly(Indoor) Set')
    roc_curve.full_test(model, unconfident_misclassified_test_loader, mode="unconfident", save_to_file="shadows/roc/unconfident_firefly_indoor", title='ROC for Unconfident/Misclassified Firefly(Indoor) Set')
